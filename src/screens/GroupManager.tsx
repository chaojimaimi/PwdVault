			...
			<div className="group-manager-content screen-scroll-region">
				...
				{isCreating && (
					<div className="group-create-bar">
						...
						<button
							className="btn btn-icon group-create-cancel"
							onClick={() => {
								setIsCreating(false);
								setNewGroupName("");
							}}
						...
						<div key={g.id} className="group-card">
							{editingId === g.id ? (
								<div className="group-card-edit">
									...
									<button
										className="btn btn-secondary group-edit-cancel"
										onClick={cancelEdit}
									>
										Cancel
									</button>
									...
									<div className="group-card-info">
										...
										<div className="group-card-text">
											...
											<span className="group-card-count">
												...
												{groupCounts.get(g.id) === 1 ? "entry" : "entries"}
											</span>
										</div>
									</div>
									<div className="group-card-actions">
										<button
											className="btn btn-icon group-action-rename"
											onClick={() => {
												setEditingId(g.id);
										...
										<button
											className="btn btn-icon group-action-delete"
											onClick={() =>
